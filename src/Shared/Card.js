    ...
    return (
        ...
        <div  className="card card-side productCard">
          ...
          <div className="card-body">
            <h2 className="card-title  text-primary">{name.slice(0,33)}</h2>
            ...
            <button onClick={()=>handleExchange(_id)} className="px-4 text-xs p-2 w-[80%] font-bold rounded uppercase exploreButton btn-primary ">Explore More</button>
           </div>  
          </div>
        </div>
      </div>
